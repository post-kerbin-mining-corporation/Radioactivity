...
namespace Radioactivity
{
    ...
    public class RadiationInstrument : PartModule, IRadiationAbsorber
    {
        ...
        public override string GetInfo()
        {
            ...
            toRet += String.Format("-{0}Sv/s: {1:F2}%\n", FormatUtils.ToSI(0, "F2"), Mathf.Clamp01(1f - PenaltyCurve.Evaluate(0f)) * 100f);
            toRet += String.Format("-{0}Sv/s: {1:F2}%\n", FormatUtils.ToSI(1, "F2"), Mathf.Clamp01(1f - PenaltyCurve.Evaluate(1f)) * 100f);
            toRet += String.Format("-{0}Sv/s: {1:F2}%\n", FormatUtils.ToSI(5, "F2"), Mathf.Clamp01(1f - PenaltyCurve.Evaluate(5f)) * 100f);
            return toRet;
        }

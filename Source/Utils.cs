...
namespace Radioactivity
{
  ...
  public static class Utils
  {
    ...
    public static float GetDisplacement(Part p)
    {
      ...
      float xzPortion = (Math.Min(xPortion, zPortion) + 2d * (xPortion * zPortion)) * (1d / 3d);
    ...
    public static Log(string str)
    {
      Debug.Log("Radioactivity: " + str)
    }
    public static LogError(string str)
    {
      Debug.LogError("Radioactivity: " + str)
    }
    public static LogWarning(string str)
    {
